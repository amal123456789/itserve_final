...
class getAllDataState extends State<getalldata> {
  ...
  Future<List<DataDestinationModel>> getDataSource() async {
    ...
    var data = await http.get(
        'http://165.227.228.41:8080/projetPfe/apidatadest/allhitdatadestination',
        headers: headers);
...
class DetailPage extends StatelessWidget {
  ...
  deletedatas1(DataDestinationModel datasource) async {
    final url = Uri.parse('http://165.227.228.41:8080/projetPfe/apidatadest/deleteddatadest');
                ...
                Container(
                  child: Column(
                    children: [
                      ...
                      Row(
                        children: [
                          Text('portDestination :' + ' ',
                              style: TextStyle(
                                  color: Colors.grey[800],
                                  fontWeight: FontWeight.bold,
                                  fontSize: 20,
                                  fontStyle: FontStyle.normal)),
                          Text(data.portDestination,
                              style: TextStyle(
                                  color: Colors.grey[800],
                                  fontWeight: FontWeight.w100,
                                  fontSize: 20,
                        ...
                        children: [
                          Text('descritpionDestination : ' + ' ',
                              style: TextStyle(
                                  ...
                                  fontSize: 20,
                                  fontStyle: FontStyle.normal)),
                          Text(data.descritpionDestination + ' ',
                              style: TextStyle(
                                  color: Colors.grey[800],
                                  fontWeight: FontWeight.w100,
                                  fontSize: 20,
