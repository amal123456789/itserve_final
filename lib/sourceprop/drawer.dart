...
import 'package:itservpfeapp/sourceprop/register.dart';
...
class drawerSState extends State<drawerS> with SingleTickerProviderStateMixin {
  //final minimumPadding = 5.0;
  static const List<Tab> myTabs = <Tab>[
    Tab(
      text: 'New source properties',
    ),
    Tab(text: 'All Data'),
  ];
