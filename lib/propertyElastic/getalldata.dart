...
import 'package:itservpfeapp/propertyElastic/delete.dart';
import 'dart:convert';

import 'package:itservpfeapp/propertyElastic/update.dart';
...
class getAllDataState extends State<getalldata> {
  ...
  Future<List<PropertiesModel>> getDataSource() async {
    ...
    var data = await http.get('http://165.227.228.41:8080/projetPfe/apiproperties/allhitprop',
        headers: headers);
...
class DetailPage extends StatelessWidget {
  ...
  deletedatas1(PropertiesModel datasource) async {
    final url = Uri.parse('http://165.227.228.41:8080/projetPfe/apiproperties/deleteprop');
    var headers = await AuthenticationHeaderService.createAuthHeader();
