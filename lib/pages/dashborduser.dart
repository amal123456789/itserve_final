...
import 'package:itservpfeapp/pages/webview_user.dart';
...
class userDashboard extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
     final _width = (MediaQuery.of(context).size.width * 0.47).truncateToDouble();
     final _height = (MediaQuery.of(context).size.height * 0.75).truncateToDouble(); 
